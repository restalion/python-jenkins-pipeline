...
pipeline {
    agent {
        docker {
            image 'restalion/pyhton-jenkins-docker:0.2'
        }
    }
    ...
    stages {
        ...
        stage('Mutation tests') {
            steps {
                ...
                sh "cosmic-ray init cosmic-ray-config.yml jenkins_session && cosmic-ray --verbose exec jenkins_session && cosmic-ray dump jenkins_session | cr-report"    
            }
        }
